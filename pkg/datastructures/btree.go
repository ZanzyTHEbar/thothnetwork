...
func (t *BTree) Get(key string) (interface{}, bool) {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func (t *BTree) search(node *BTreeNode, key string) (interface{}, bool) {
	i := 0
...
func (t *BTree) Put(key string, value interface{}) {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *BTree) insertNonFull(node *BTreeNode, key string, value interface{}) {
	i := len(node.keys) - 1
...
func (t *BTree) findMax(node *BTreeNode) (string, interface{}) {
	if node.leaf {
...
func (t *BTree) findMin(node *BTreeNode) (string, interface{}) {
	if node.leaf {
...
func (t *BTree) borrowFromPrev(node *BTreeNode, index int) {
	...
	child.values = append([]interface{}{nil}, child.values...)
...
func (t *BTree) ForEach(fn func(key string, value interface{}) bool) {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func (t *BTree) forEach(node *BTreeNode, fn func(key string, value interface{}) bool) bool {
	if node == nil {
		return true
	}
...
func (t *BTree) Keys() []string {
	...
	t.ForEach(func(key string, _ interface{}) bool {
...
func (t *BTree) Values() []interface{} {
	...
	t.ForEach(func(_ string, value interface{}) bool {
