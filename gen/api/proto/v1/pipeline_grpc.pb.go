...
const (
	PipelineService_CreatePipeline_FullMethodName = "/thothnetwork.v1.PipelineService/CreatePipeline"
	PipelineService_GetPipeline_FullMethodName    = "/thothnetwork.v1.PipelineService/GetPipeline"
	PipelineService_UpdatePipeline_FullMethodName = "/thothnetwork.v1.PipelineService/UpdatePipeline"
	PipelineService_DeletePipeline_FullMethodName = "/thothnetwork.v1.PipelineService/DeletePipeline"
	PipelineService_ListPipelines_FullMethodName  = "/thothnetwork.v1.PipelineService/ListPipelines"
	PipelineService_ProcessMessage_FullMethodName = "/thothnetwork.v1.PipelineService/ProcessMessage"
	PipelineService_StartPipeline_FullMethodName  = "/thothnetwork.v1.PipelineService/StartPipeline"
	PipelineService_StopPipeline_FullMethodName   = "/thothnetwork.v1.PipelineService/StopPipeline"
)
...
func (c *pipelineServiceClient) ProcessMessage(ctx context.Context, in *ProcessMessageRequest, opts ...grpc.CallOption) (*ProcessMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessMessageResponse)
	err := c.cc.Invoke(ctx, PipelineService_ProcessMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPipelineServiceServer) ProcessMessage(context.Context, *ProcessMessageRequest) (*ProcessMessageResponse, error) {
...
func _PipelineService_ProcessMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PipelineServiceServer).ProcessMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PipelineService_ProcessMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PipelineServiceServer).ProcessMessage(ctx, req.(*ProcessMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PipelineService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "thothnetwork.v1.PipelineService",
	...
	Metadata: "api/proto/v1/pipeline.proto",
}
